...
## Summary
- **Open:** 10 · **Fixed:** 5 (DIR-3, CRED-1, CRED-2, DOC-1, DOC-3) · **Withdrawn:** 1 (DIR-1) · **Regressed:** 0 (baseline — nothing to compare against)
- **Open by severity:** P0 × 0 · P1 × 2 (TEST-1 *in progress*, ARCH-1) · P2 × 5 · P3 × 3
