...
type Application struct {
	...
	// +kubebuilder:validation:XValidation:rule="!('*' in self.managementPolicies || 'Create' in self.managementPolicies || 'Update' in self.managementPolicies) || has(self.forProvider.objectStoragePath) || (has(self.initProvider) && has(self.initProvider.objectStoragePath))",message="spec.forProvider.objectStoragePath is a required parameter"
	// +kubebuilder:validation:XValidation:rule="!('*' in self.managementPolicies || 'Create' in self.managementPolicies || 'Update' in self.managementPolicies) || has(self.forProvider.setupCores) || (has(self.initProvider) && has(self.initProvider.setupCores))",message="spec.forProvider.setupCores is a required parameter"
	// +kubebuilder:validation:XValidation:rule="!('*' in self.managementPolicies || 'Create' in self.managementPolicies || 'Update' in self.managementPolicies) || has(self.forProvider.setupMemory) || (has(self.initProvider) && has(self.initProvider.setupMemory))",message="spec.forProvider.setupMemory is a required parameter"
	// +kubebuilder:validation:XValidation:rule="!('*' in self.managementPolicies || 'Create' in self.managementPolicies || 'Update' in self.managementPolicies) || has(self.forProvider.setupStorageCapacity) || (has(self.initProvider) && has(self.initProvider.setupStorageCapacity))",message="spec.forProvider.setupStorageCapacity is a required parameter"
