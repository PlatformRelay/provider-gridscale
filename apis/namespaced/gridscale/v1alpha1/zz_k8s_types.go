...
type K8SInitParameters struct {
	...
	LogDeliveryAccessKeySecretRef *v1.LocalSecretKeySelector `json:"logDeliveryAccessKeySecretRef,omitempty" tf:"-"`
	...
	LogDeliverySecretKeySecretRef *v1.LocalSecretKeySelector `json:"logDeliverySecretKeySecretRef,omitempty" tf:"-"`
...
type NodePoolInitParameters struct {
	...
	// List of labels to be applied to the nodes of this pool. Check the product documentation for details
	// List of labels to be applied to the nodes of this pool.
	...
	// List of taints to be applied to the nodes of this pool. Check the product documentation for details
	// List of taints to be applied to the nodes of this pool.
