...
type CacheInitParameters struct {
	...
	// Performance class of Redis cache service. Available performance classes at the time of writing: standard, high, insane, ultra.
	...
	// The Redis cache release of this instance. For convenience, please use gscloud to get the list of available Redis cache service releases.
...
type CacheObservation struct {
	...
	// The port numbers where this Redis cache service accepts connections.
	// The port numbers where this Redis cache service accepts connections.
	...
	// PaaS service template that Redis cache service uses.
	// PaaS service template that Redis cache service uses.
	...
	// Current status of Redis cache service.
	Status *string `json:"status,omitempty" tf:"status,omitempty"`

	// Number of minutes that PaaS service is in use.
	// Number of minutes that Redis cache service is in use.
