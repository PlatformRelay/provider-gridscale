...
func (mg *Sqlserver) GetTerraformResourceType() string {
	return "gridscale_sqlserver"
}

// GetConnectionDetailsMapping for this Sqlserver
func (tr *Sqlserver) GetConnectionDetailsMapping() map[string]string {
	return map[string]string{"password": "status.atProvider.password", "s3_backup[*].backup_access_key": "s3Backup[*].backupAccessKeySecretRef", "s3_backup[*].backup_secret_key": "s3Backup[*].backupSecretKeySecretRef", "username": "status.atProvider.username"}
}

// GetObservation of this Sqlserver
func (tr *Sqlserver) GetObservation() (map[string]any, error) {
...
func (tr *Sqlserver) SetObservation(obs map[string]any) error {
...
// GetID returns ID of underlying Terraform resource of this Sqlserver
func (tr *Sqlserver) GetID() string {
...
func (tr *Sqlserver) GetParameters() (map[string]any, error) {
...
func (tr *Sqlserver) SetParameters(params map[string]any) error {
...
// GetInitParameters of this Sqlserver
func (tr *Sqlserver) GetInitParameters() (map[string]any, error) {
...
// GetInitParameters of this Sqlserver
func (tr *Sqlserver) GetMergedParameters(shouldMergeInitProvider bool) (map[string]any, error) {
