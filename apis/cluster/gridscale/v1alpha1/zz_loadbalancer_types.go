...
type BackendServerInitParameters struct {
	...
	// +crossplane:generate:reference:type=github.com/PlatformRelay/provider-gridscale/apis/cluster/gridscale/v1alpha1.IPv4
	...
	HostRef *v1.Reference `json:"hostRef,omitempty" tf:"-"`

	// Selector for a IPv4 in gridscale to populate host.
	// +kubebuilder:validation:Optional
	HostSelector *v1.Selector `json:"hostSelector,omitempty" tf:"-"`
...
type ForwardingRuleInitParameters struct {
	...
	// The UUID of a custom certificate.
	// +crossplane:generate:reference:type=github.com/PlatformRelay/provider-gridscale/apis/cluster/ssl/v1alpha1.Certificate
...
type LoadbalancerInitParameters struct {
	...
	// The UUID of the IPv6 address the Load balancer will listen to for incoming requests.
	// +crossplane:generate:reference:type=github.com/PlatformRelay/provider-gridscale/apis/cluster/gridscale/v1alpha1.IPv6
