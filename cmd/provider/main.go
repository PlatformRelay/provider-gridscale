...
import (
	...
	apisCluster "github.com/PlatformRelay/provider-gridscale/apis/cluster"
	apisNamespaced "github.com/PlatformRelay/provider-gridscale/apis/namespaced"
	"github.com/PlatformRelay/provider-gridscale/config"
	"github.com/PlatformRelay/provider-gridscale/internal/clients"
	controllerCluster "github.com/PlatformRelay/provider-gridscale/internal/controller/cluster"
	controllerNamespaced "github.com/PlatformRelay/provider-gridscale/internal/controller/namespaced"
	"github.com/PlatformRelay/provider-gridscale/internal/features"
	"github.com/PlatformRelay/provider-gridscale/internal/version"
)
...
func main() {
	...
	kingpin.FatalIfError(apisCluster.AddToScheme(mgr.GetScheme()), "Cannot add cluster-scoped Gridscale APIs to scheme")
	kingpin.FatalIfError(apisNamespaced.AddToScheme(mgr.GetScheme()), "Cannot add namespaced Gridscale APIs to scheme")
	...
	if *enableChangeLogs {
		...
		clo := xpcontroller.ChangeLogOptions{
			ChangeLogger: managed.NewGRPCChangeLogger(
				...
				managed.WithProviderVersion(fmt.Sprintf("provider-gridscale:%s", version.Version))),
		}
